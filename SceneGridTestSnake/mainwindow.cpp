    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(&snakeLogick,&SnakeLogick::recalculatedSnake,
...
void MainWindow::createMaze(stateArr &_states)
{
...
void MainWindow::generateSnakes()
{
    snakeLogick.setGridMatrix(&states);
    snakeLogick.generateSnake();
    snakeLogick.setTimeOfMovement(1500);
    snakeLogick.moveSnakeOnScene(true);
