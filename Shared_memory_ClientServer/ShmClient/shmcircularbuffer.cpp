...
{
    std::lock_guard<std::mutex> lck(m_acessDataMtx);
    ...
    if (sem_post (mutex_sem) == -1)
        throw "error in releasing waiting semaphore for writing message from concrete client";
...
void ShmCircularBuffer::open()
{
    ...
    /*Now part of depending is it client or server application.*/
    ...
    case ServerBuffer:
        ...
        // counting semaphore, indicating the number of buffers for reading. Initial value = 0
    ...
    case ClientBuffer:
        ...
        // counting semaphore, indicating the number of buffers for writing. Initial value = 0
